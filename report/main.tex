...
\texttt{core/} added as a peer source module. The diagram groups the three management files
...
The suite contains 42 representative \texttt{pytest} cases, all passing at the time of
...
Lost-stage test accounts for four of the 42 cases.

...
| Phase 2 — Dashboards | `test_repo.py`, `test_http.py` | Monthly revenue, EMA, team order, workload, stale boundaries, Manager overview Kanban, and scoped Director team-drill-down Kanban. |
